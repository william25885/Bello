...
declare const _default: __VLS_WithTemplateSlots<import('vue').DefineComponent<{
    ...
    "update:modelValue": (modelValue: import('../../types/CommonTypes').Numberish) => any;
    "page-click": (event: BvEvent, pageNumber: number) => any;
}, string, import('vue').PublicProps, Readonly<{
    modelValue?: Exclude<BPaginationProps["modelValue"], undefined>;
} & Omit<BPaginationProps, "modelValue">> & Readonly<{
    "onUpdate:modelValue"?: ((modelValue: import('../../types/CommonTypes').Numberish) => any) | undefined;
...
}, {}, {}, {}, string, import('vue').ComponentProvideOptions, false, {}, any>, Partial<Record<{}, (_: {
    disabled: unknown;
    page: unknown;
    index: unknown;
    active: unknown;
